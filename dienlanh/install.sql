...
BEGIN
    ...
    (N'Có hỗ trợ sửa chữa ngoài giờ hành chính không?', N'Có, chúng tôi hỗ trợ sửa chữa khẩn cấp ngoài giờ hành chính và cả ngày lễ, cuối tuần. Đội ngũ kỹ thuật viên trực 24/7 sẵn sàng hỗ trợ bạn bất cứ khi nào gặp sự cố.', 4, 'active'),
