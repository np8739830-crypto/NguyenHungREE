const express = require('express'); const path = require('path'); const { createResourceController } = require('../controllers/resourceController'); const { requireAuth } = require('../middleware/auth'); const { rejectBots } = require('../middleware/security'); const { sendContactNotification } = require('../services/telegramService'); const { uploadRequestImages } = require('../services/requestImageService');
