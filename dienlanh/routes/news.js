...
const router = express.Router(); const controller = createResourceController('news', [], { where: "status = 'published' AND slug <> 'huong-dan-ve-sinh-may-lanh-tai-nha'", orderBy: 'published_at DESC' });
